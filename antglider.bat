...
REM This code is adopted from ant.bat.
REM Please feel free to modify.
REM I changed the jar file, that holds the starting class.
REM -classpath "%ANT_HOME%\lib\antglider.jar"
...
"%_JAVACMD%" %ANT_OPTS% -classpath "%ANT_HOME%\lib\antglider.jar" "-Dant.home=%ANT_HOME%" "-Djikes.class.path=%JIKESPATH%" org.apache.tools.ant.launch.Launcher %ANT_ARGS%  -cp "%CLASSPATH%" %ANT_CMD_LINE_ARGS%
rem Check the error code of the Ant build
if not "%OS%"=="Windows_NT" goto onError
set ANT_ERROR=%ERRORLEVEL%
goto end
...
"%_JAVACMD%" %ANT_OPTS% -classpath "%ANT_HOME%\lib\antglider.jar" "-Dant.home=%ANT_HOME%" "-Djikes.class.path=%JIKESPATH%" org.apache.tools.ant.launch.Launcher %ANT_ARGS% %ANT_CMD_LINE_ARGS%
rem Check the error code of the Ant build
if not "%OS%"=="Windows_NT" goto onError
set ANT_ERROR=%ERRORLEVEL%
goto end
