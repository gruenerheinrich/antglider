...
public class MoveBackwardShortCutAction extends AntRunnerAction {
	public MoveBackwardShortCutAction() {
		super("Move Left",AntRunner.getResourceImageIcon("arrow_up.png"));
