...
public class MoveForwardShortCutAction extends AntRunnerAction {
	public MoveForwardShortCutAction() {
		super("Move Right",AntRunner.getResourceImageIcon("arrow_down.png"));
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			this.antrunner.moveCurrentShortCut(1);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
	}
